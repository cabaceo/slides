...
<img src="img/pane-layout.png" alt="" style="width: 60%;"/>
...
- use lower case 
    - Good: student <- 25; foo.R, 
    - Bad : Student <- 25; Foo.R
- use _ to connect
    - Good: learn_shiny <- function(start, end)
    - Bad : learnShiny  <- function(start, end)
